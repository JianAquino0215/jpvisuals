  ...
  return (
    <div className="sm-scope w-full h-full">
      ...
      >
        ...
        {open && (
          <div 
            className="fixed inset-0 bg-black/20 z-[1] pointer-events-auto" 
            onClick={closeMenu}
            aria-hidden="true"
          />
        )}
        ...
        >
          <button
            className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center text-black hover:text-red-500 transition-colors duration-200 md:hidden"
            onClick={closeMenu}
